...
- **Pipe já criado**: "CX — Casos com Decisão Financeira", `https://app.pipefy.com/pipes/307274227`. Próximo passo do Cowork: auditar o pipe existente contra este blueprint (fases, campos do start form, checklist de evidências, gate do Head, dashboards) e reportar `pipe_id`/`field_ids` para registro em `../integracoes/pipefy-cx.md`.

...
> Este documento é a camada comum de comportamento. **Todas as regras aqui valem para todos os agentes (A1 a A11)** e devem ser cadastradas na base de conhecimento vinculada a todos os agentes Núb.ia Resolve do projeto. As regras específicas de cada perfil estão nos documentos da pasta `agentes/`.
...
3. Regras específicas do agente do perfil (documentos A1–A11);

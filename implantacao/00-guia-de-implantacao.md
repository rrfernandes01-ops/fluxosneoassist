...
| 3 | Agentes de IA | Núb.ia Resolve → criar 10 agentes | `passo-3-agentes/prompt-A1.md` … `prompt-A10.md` |
...
2. **Vincule os artigos 01–04 e 06 do passo 1 a TODOS os 10 agentes** (são a camada comum de comportamento). O **artigo 05 (Regras de tratativa por marketplace)** é vinculado ao agente **A3** (e opcionalmente ao A1, para redirecionamentos corretos).
...
- [ ] Artigos 01–04 e 06 publicados e vinculados aos 10 agentes; artigo 05 vinculado ao A3.
...
- [ ] 10 agentes criados com os prompts do passo 3, cada um com fila de transbordo vinculada.
- [ ] Fluxo mestre publicado no canal WhatsApp com os 10 hand-offs + ramo de exceção.
